...
public class MazeWithKey extends Applet implements KeyListener{
   ...
   public static void placePlayer(char[][] mazeArray) throws IOException{
      ...
      do{
         ...
         yLoc = randomNumbers.nextInt(mazeArray.length);
         xLoc = randomNumbers.nextInt(mazeArray[0].length);
